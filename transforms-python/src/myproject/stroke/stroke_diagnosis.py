...
@transform_df(
    Output("/NHS/Cancer Late Presentation Likelihood Modelling Internal Transforms/cancer-late-datasets/interim-datasets/stroke_diagnosis"),
...
def compute(df_comorbidities, df_icd10_ref):
    ...
    df_stroke_only = utils.create_comorbidity_features(df_stroke_only.select("patient_pseudo_id", "date", "diagnosis"), "stroke_before_cut_off")

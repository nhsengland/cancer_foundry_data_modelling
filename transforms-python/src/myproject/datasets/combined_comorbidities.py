...
@transform_df(
    Output("/NHS/Cancer Late Presentation Likelihood Modelling Internal Transforms/cancer-late-datasets/interim-datasets/combined_comorbidities"),
    ...
    df_ae_comorbidities=Input("ri.foundry.main.dataset.cf9cd953-d9c4-486f-9130-607c252ed8e1"),
    df_icd10_ref=Input("ri.foundry.main.dataset.3a0dfe4b-67de-4001-87eb-e43405df76d3")
)
def compute(df_inpatient_comorbidities, df_outpatient_comorbidities, df_ae_comorbidities, df_icd10_ref):
    """
    ...
    df_ae_comorbidities = df_ae_comorbidities.select("patient_pseudo_id", "date", "diagnosis", "source")
    ...
    df_inpatient_comorbidities = df_inpatient_comorbidities.select("patient_pseudo_id", "date", "diagnosis", "source")
    df_outpatient_comorbidities = df_outpatient_comorbidities.select("patient_pseudo_id", "date", "diagnosis", "source")

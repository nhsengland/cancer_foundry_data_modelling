...
def compute(inpatient_activity):
    ...
    """
    inpatient_activity = inpatient_activity.select("patient_pseudo_id", "activity_id", "attendance_date", "dimention_8")
    ...
    df_comorbidity_inpatient = df_comorbidity_inpatient.drop_duplicates(["patient_pseudo_id", "date", "diagnosis"])

    return df_comorbidity_inpatient.select("patient_pseudo_id", "activity_id", "date", "diagnosis", "source")
